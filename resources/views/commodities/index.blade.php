        ...
        <div class="flex justify-between">
            <div class="w-2/5">
                ...
                <ul>
                    <li class="mb-2">
                    {{-- /のルーティングに行く --}}
                    <a href="/" class="hover:text-blue-500 {{ Request::get('faculty_id') ?: 'text-green-500 font-bold' }}">
                            全て
                        </a>
                    </li>
                    ...
                    {{-- /がないとcomodities/commoditiesに行ってしまう --}}
                            <a href="/commodities/?faculty_id={{ $f->id }}" class="hover:text-blue-500 {{ Request::get('faculty_id') == $f->id ? 'text-green-500 font-bold' : '' }}">
                                {{ $f->name }}
                            </a>
                        </li>
                    @endforeach
