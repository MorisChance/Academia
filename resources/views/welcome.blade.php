            ...
            <div class="h-full flex flex-auto bg-purple-900 text-white bg-no-repeat bg-cover relative bg-image">
                <div
                    ...
                    <div class="w-4/5 z-10">
                        <h2 class="text-xl xl:text-4xl italic mb-2">Academia</h2>
                        <div class="text-5xl sm:text-5xl xl:text-8xl font-bold leading-tight mb-6">最高の教科書を<br>手に入れよう
                        </div>
                        <div class="sm:text-sm xl:text-md text-gray-400 font-bold">Academiaは、自由に教科書を売買できるプラットフォームです。
                        </div>
                    </div>
                    <div
                            ...
                            <div class="text-center text-white">
                                    ...
                                    <p class="flex flex-col items-center justify-center mt-10 text-center text-md">
                                        ...
                                        <a href="{{ route('register') }}"
                                            class="text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300 underline decoration-solid">Sign
                                        up</a>
                                    </p>
                                </div>
                        </div>
