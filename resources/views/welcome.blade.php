        ...
        <div
            ...
            <div class="h-full flex flex-auto bg-purple-900 text-white bg-no-repeat bg-cover relative bg-image">
                <div
                    ...
                    <div class="absolute bg-gradient-to-b from-indigo-900 to-black opacity-20 inset-0 z-0"></div>
                    <div class="w-4/5 z-10">
                        ...
                        {{-- <div class="sm:text-2xl xl:text-md text-white font-bold">Academiaは、自由に教科書を売買できるプラットフォームです。
                        </div> --}}
                    </div>
                    <div
